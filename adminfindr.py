...
class adminfinder():
    ...
    print bcolors.HEADER + "\t#+#     #+# #+#    #+# #+#       #+#     #+#     #+#   #+#+# " + bcolors.ENDC
    print bcolors.HEADER + "\t###     ### #########  ###       ### ########### ###    #### " + bcolors.ENDC
    print bcolors.HEADER + "\t				Tools Admin Finder:D" + bcolors.ENDC
    print bcolors.HEADER + "\t				Created By MataKucing" + bcolors.ENDC
    print ""
        ...
        try:
            ...
            for word in wordlist:
                ...
                if response.status == 200:
                    print bcolors.GREEN + "\n\n\t+------------------------------------------------------+" + bcolors.ENDC
                    print "%s %s" % (bcolors.GREEN + "\t[!] Admin Page Found >> " + bcolors.ENDC, bcolors.RED + target + bcolors.ENDC)
                    print bcolors.GREEN + "\t+------------------------------------------------------+\n" + bcolors.ENDC
            ...
            print bcolors.RED + "\n\t[!] Session Cancelled." + bcolors.ENDC
            print bcolors.RED + "\t[!] Check Your Internet Connection" + bcolors.ENDC
        except (KeyboardInterrupt, SystemExit):
            print bcolors.RED + "\t[!] Session Cancelled." + bcolors.ENDC
